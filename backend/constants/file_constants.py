...
USER_DATA = os.path.join(DATABASE_DIR, "user.xlsx")
...
OUTPUT_FILES = {
    ...
    "ANALYTICS_SUMMARY": os.path.join(DATABASE_DIR, "analytics_summary.json")
}

# Sheet Names
SHEET_NAMES = {
    "EV_SUMMARY": "EV_Summary",
    "FREIGHTLINER_EV": "Freightliner_EV",
    "VAN_EV": "Van_EV",
    "CAR_SUV_EV": "Car_SUV_EV",
    "PICKUP_EV": "Pickup_EV",
...
def ensure_output_directory():
    """Alias for ensure_database_directory for backward compatibility"""
    return ensure_database_directory()
